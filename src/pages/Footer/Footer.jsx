          ...
          <div className="box_1">
            <div className="row">
              <div className="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                <img className='img1' src="https://cdn-icons-png.flaticon.com/512/4408/4408037.png" alt="img" />
              </div>
              <div className="col-xl-6 col-lg-7 col-md-7 col-sm-6 col-12">
                <p className='p_element'>Stand out as a company!</p>
                <h5 className='h5_element'>OLX bilan internetda biznesingizni boshlang!</h5>
              </div>
              <div className="col-xl-3 col-lg-2 col-md-2 col-sm-3 col-12">
                <button className='batafsil'>Batafsil</button>
              </div>
            </div>
          </div>
          <div className="box_2">
            <h1 className='brend'>olx</h1>
            <p className='text'>Oʻzbekistonda 1-raqamli eʼlonlar servisi
          ...
          <div className="box_3">
            <div className="container-fluid">
              ...
              <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                <img className='img1' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQvxFqzpcyCjTRv91UuNg-0IKIhsXEefQSanIsezK2tfA&s" alt="img" />
                <p><span>OLX servisining boʻlimlari:</span> Bolalar dunyosi, Ko'chmas mulk, Transport, Ish, Hayvonlar, Uy va bog', Elektr jihozlari, Xizmatlar, Moda va stilXobbi, dam olish sport, Tekinga beraman, Ayirboshlash</p>
              </div>
              <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                <img className='img2' src="https://www.grandslamdesigns.com/images/thumbs/0222834_magnifying-glass_625.jpeg" alt="img" />
                <p><span>Mashhur qidiruvlar:</span> iphone 11, spark, samsung, iphone, byd, квартира, matiz, damas, спарк, kvartir, aiphone 13 pronexia 2, telefon, malibu 2, redmi, велосипед, ish, monza,cobalt, velosiped</p>
              </div>
              </div>
            </div>
          </div>
